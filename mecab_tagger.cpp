...
my_bool mecab_yomi_init(UDF_INIT *initid, UDF_ARGS *args, char *message);
void mecab_yomi_deinit(UDF_INIT *initid);
char *mecab_yomi(UDF_INIT *initid, UDF_ARGS *args, char *result, unsigned long *ret_length, char *is_null, char *error);
}
...
char *mecab_yomi(UDF_INIT *initid, UDF_ARGS *args, char *result,
                   unsigned long *ret_length, char *is_null, char *error)
